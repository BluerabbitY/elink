...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const ParameterScaledValue& io)
    {
        return stream << io.valueM << io.qpmM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, ParameterScaledValue& io)
    {
        return stream >> io.valueM >> io.qpmM;
    }
