...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const IntegratedTotalsWithCP24Time2a& io)
    {
        return stream << io.bcrM.valueM << io.bcrM.seqM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, IntegratedTotalsWithCP24Time2a& io)
    {
        return stream >> io.bcrM.valueM >> io.bcrM.seqM >> io.cpxxtime2aM;
    }
