...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const BitString32Command& io)
    {
        return stream << io.valueM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, BitString32Command& io)
    {
        return stream >> io.valueM;
    }
