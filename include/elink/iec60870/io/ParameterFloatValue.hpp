...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const ParameterFloatValue& io)
    {
        return stream << io.valueM << io.qpmM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, ParameterFloatValue& io)
    {
        return stream >> io.valueM >> io.qpmM;
    }
