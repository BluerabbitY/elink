...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const DoublePointWithCP56Time2a& io)
    {
        return stream << io.diqM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, DoublePointWithCP56Time2a& io)
    {
        return stream >> io.diqM >> io.cpxxtime2aM;
    }
