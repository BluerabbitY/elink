...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const BitString32WithCP24Time2a& io)
    {
        return stream << io.valueM << io.qualityM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, BitString32WithCP24Time2a& io)
    {
        return stream >> io.valueM >> io.qualityM >> io.cpxxtime2aM;
    }
