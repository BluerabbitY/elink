...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const MeasuredValueNormalized& io)
    {
        return stream << io.valueM << io.qualityM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, MeasuredValueNormalized& io)
    {
        return stream >> io.valueM >> io.qualityM;
    }
