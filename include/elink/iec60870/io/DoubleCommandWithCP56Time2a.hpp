...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const DoubleCommandWithCP56Time2a& io)
    {
        return stream << io.valueM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, DoubleCommandWithCP56Time2a& io)
    {
        return stream >> io.valueM >> io.cpxxtime2aM;
    }
