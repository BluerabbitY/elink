...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const PackedStartEventsOfProtectionEquipmentWithCP56Time2a& io)
    {
        return stream << io.eventM << io.qdpM << io.elapsedTimeM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, PackedStartEventsOfProtectionEquipmentWithCP56Time2a& io)
    {
        return stream >> io.eventM >> io.qdpM >> io.elapsedTimeM >> io.cpxxtime2aM;
    }
