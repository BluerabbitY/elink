...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const PackedOutputCircuitInfoWithCP56Time2a& io)
    {
        return stream << io.ociM << io.qdpM << io.operatingTimeM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, PackedOutputCircuitInfoWithCP56Time2a& io)
    {
        return stream >> io.ociM >> io.qdpM >> io.operatingTimeM >> io.cpxxtime2aM;
    }
