...
protected:
    ...
    friend elink::details::OStream& operator<<(elink::details::OStream& stream, const StepCommandWithCP56Time2a& io)
    {
        return stream << io.valueM << io.cpxxtime2aM;
    }

    friend elink::details::IStream& operator>>(elink::details::IStream& stream, StepCommandWithCP56Time2a& io)
    {
        return stream >> io.valueM >> io.cpxxtime2aM;
    }
