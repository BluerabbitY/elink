...
constexpr uint8_t CP16Time2aTag = 2;
...
public:
    ...
    explicit CPxxTime2aImp(const uint64_t timestamp) requires (N == CP32Time2aTag || N == CP56Time2aTag)
    {
    ...
    CPxxTime2aImp(CPxxTime2aImp&) = default;

    CPxxTime2aImp& operator=(const CPxxTime2aImp&) = default;
